...
export default function Footer() {
  return (
    <footer className="mt-[1px] border-t border-gray-200">
      {/* 1. Categorías Rápidas - Barra Roja */}
      <nav className="w-full bg-[#bb1b21] relative z-20">
            ...
            {CATEGORIES.map((cat) => (
              <li key={cat.slug} className="flex-shrink-0">
                <Link
                  ...
                  className="px-3 md:px-4 py-3 text-[10px] font-black uppercase tracking-[0.2em] text-white/90 hover:text-white transition-all whitespace-nowrap"
                >
                  {cat.label}
                </Link>
              </li>
            ...
            <div className="md:col-span-4 flex flex-col items-center md:items-start text-center md:text-left">
              ...
              <div className="flex gap-4">
                {[
                  ...
                  { name: 'WA', url: "https://wa.me/8296371008", icon: (<path d="M21 11.5a8.38 8.38 0 0 1-.9 3.8 8.5 8.5 0 0 1-7.6 4.7 8.38 8.38 0 0 1-3.8-.9L3 21l1.9-5.7a8.38 8.38 0 0 1-.9-3.8 8.5 8.5 0 0 1 4.7-7.6 8.38 8.38 0 0 1 3.8-.9h.5a8.48 8.48 0 0 1 8 8v.5z"/>) },
