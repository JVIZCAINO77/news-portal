          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16">
            ...
            <div className="lg:col-span-3">
              ...
              <ul className="space-y-4">
                ...
                <li key="politica-editorial"><Link href="/politica-editorial" className="text-[12px] font-bold text-white/50 hover:text-red-600 transition-colors uppercase">Política Editorial</Link></li>
                <li key="newsletter"><Link href="/newsletter" className="text-[12px] font-black text-red-600 hover:text-white transition-colors uppercase">Newsletter / Suscríbete</Link></li>
