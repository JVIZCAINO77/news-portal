...
export default function BreakingTicker({ items = [] }) {
  ...
  return (
    <div className="bg-white border-y-2 border-gray-200 overflow-hidden select-none">
      <div className="max-w-6xl mx-auto px-4 md:px-8 flex items-center h-10 md:h-12">
        {/* Label Fijo */}
