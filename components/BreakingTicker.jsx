...
export default function BreakingTicker({ items = [] }) {
  ...
  return (
    <div className="bg-yellow-400 border-y border-yellow-500 overflow-hidden select-none">
      <div className="max-w-7xl mx-auto flex items-center h-10 md:h-12">
        {/* Label Fijo */}
        <div className="bg-black text-yellow-400 px-4 md:px-6 h-full flex items-center justify-center relative z-10 shadow-[8px_0_12px_rgba(0,0,0,0.1)]">
