  ...
  return (
    <main className="max-w-4xl mx-auto px-6 py-12 md:py-20 font-sans text-gray-800 leading-relaxed">
      ...
      <div className="prose prose-lg max-w-none prose-headings:font-serif prose-headings:font-black prose-headings:uppercase prose-headings:tracking-tight prose-a:text-red-700">
        ...
        <section className="mb-10">
          <h2 className="text-2xl mb-4">5. Ley Aplicable y Jurisdicción</h2>
          <p>
            Para la resolución de todas las controversias o cuestiones relacionadas con el presente sitio web o de las actividades en él desarrolladas, será de aplicación la legislación dominicana, a la que se someten expresamente las partes, siendo competentes para la resolución de todos los conflictos derivados los Juzgados y Tribunales de Santo Domingo, República Dominicana.
          </p>
        </section>
      </div>
    </main>
