    ...
    <main className="max-w-4xl mx-auto py-12 px-6 lg:px-8 text-slate-800 min-h-screen bg-white">
      ...
      <div className="space-y-10 text-lg leading-relaxed font-serif">
        ...
        <section>
          ...
          <p className="mt-4">
            Para ejercer cualquiera de estos derechos, contáctanos en: <a href="mailto:jvizcaino242@gmail.com" className="text-red-600 font-bold hover:underline">jvizcaino242@gmail.com</a>
          </p>
        </section>
