      ...
      <section className="py-20 border-b border-gray-100">
        <div className="max-w-4xl mx-auto px-6">
          ...
          <div className="space-y-4 font-serif text-lg text-slate-700 leading-relaxed">
            ...
            <p>Para reportar un error: <a href="mailto:jvizcaino242@gmail.com" className="text-red-600 font-bold hover:underline">jvizcaino242@gmail.com</a> con el asunto &quot;Corrección&quot;.</p>
          </div>
        </div>
      </section>
