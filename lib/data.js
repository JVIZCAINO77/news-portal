 ...
 * ⚠️  PENDIENTE: Reemplaza los 'placeholder-...' por los IDs numéricos reales
 *     que obtienes en: Google AdSense → Anuncios → Bloques de anuncios
 *     Mientras sean placeholders, los espacios de anuncios NO mostrarán publicidad.
 */
...
// true cuando los slots reales están configurados (útil para condicionar la carga de AdSense)
export const ADS_READY = !Object.values(ADS_SLOTS).some(v => v.startsWith('placeholder'));

export const CATEGORIES = [
  { slug: 'noticias',        label: 'Nacional',         color: '#1f2937' },
  { slug: 'politica',        label: 'Política',         color: '#1f2937' },
  { slug: 'policia',         label: 'Policía',          color: '#1f2937' },
